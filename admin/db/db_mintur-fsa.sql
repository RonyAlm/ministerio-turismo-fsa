...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-08-2022 a las 22:22:59
...
(2516, '', 8, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2),
...
CREATE TABLE `gastronomia` (
  ...
  `date_updated_gastronomia` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(2, 'Segunda gastronomia', 'observacion de gastronomia dos', 370, 'dias y horarios de gastronomia dos', '2022-08-05 20:02:31'),
(5, 'Moharde', 'Bar', 300, '19:00 a 04:00', '2022-08-05 20:05:39');
...
CREATE TABLE `museo` (
  ...
  `date_updated_museo` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(3, 'Casa de la Artesanía', 'Lunes a Viernes turno mañana 8:00 a 12:00, turno tarde 16:00 a 19:00. Sábados, por la mañana 09:00 a 12:00', 228, '', 'Víctor Falcón', '2022-08-05 20:11:13'),
...
(5, 'Museo del Plan Quinquenal', 'Lunes a Viernes turno mañana 8:00 a 12:00, turno tarde 16:00 a 18:30. Sábados, domingos y feriados cerrado.', 230, 'Inaugurado el 16 de septiembre de 2013, el Museo del Plan Quinquenal se encuentra ubicado en la Escuela N°48 \"Domingo Bresanovich y Jacinto Somacal\", en la localidad de Colonia Pastoril.', '', '2022-08-05 20:11:13'),
(6, 'Museo Sacro Cultural ', 'Sàbados y Domingos Tarde 17:00 a 19:30  *Consultar por visitas guiadas durante la semana', 231, '', '', '2022-08-05 20:11:13'),
(7, 'Museo Histórico Policial \"Comisario Gral. de la Policía de Territorios Nacionales Justo Bobadilla\"', '*Cerrado por refacciones', 232, 'El Museo de la Policía de Formosa fue inaugurado el 11 de Noviembre de 1993, lleva el nombre del Comisarío General ® TTNN Dn. Justo Bobadilla', '', '2022-08-05 20:11:13'),
(8, 'Museo \"Nuestra Señora del Carmen\"', 'Cerrado', 233, '', '', '2022-08-05 20:11:13'),
(9, 'Museo y Casa de la Cultura', 'Comunicarse previamente para coordinar ', 234, '', '', '2022-08-05 20:11:13'),
(10, 'Museo \"Misión Laishi\"', 'Comunicarse para visitas guiadas', 235, '', '', '2022-08-05 20:11:13'),
(11, 'Museo del Carnaval', 'Comunicarse con la Municipalidad de Ibarreta', 236, '', '', '2022-08-05 20:11:13'),
(12, 'Museo y Casa Histórica ', 'Lunes a Viernes turno mañana 7:00 a 12:00, turno tarde 16:00 a 19:00. Sábados, domingos y feriados con aviso previo', 237, '', 'Yango Albornoz', '2022-08-05 20:11:13'),
(13, 'Museo Ferroviario', 'Lunes a Viernes turno mañana 8:00 a 12:00, turno tarde 16:00 a 20:00. Sábados, domingos y feriados de 16:00 a 21:00', 238, 'El museo adquiere, conserva, investiga, comunica y exhibe con propósito de estudio, educación y esparcimiento.', '', '2022-08-05 20:11:13'),
...
--
ALTER TABLE `calendario`
  MODIFY `id_calendario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=81;
...
--
ALTER TABLE `gastronomia`
  MODIFY `id_gastronomia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
