...
<div class="col-md-12">
            ...
            <div class="card card-success card-outline ">
                ...
                <div class="card-body">
                    ...
                    <table id="tblInfoGe" class="tblInfo table table-bordered table-striped" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <th class="sorting_1">Tipo</th>
                            <td><?php echo $informacion->descripcion_lugar ?></td>
                        </tr>

                        <tr>
                            <th class="sorting_1">Estación</th>
                            <td><?php echo $informacion->descripcion_estacion ?></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><?php echo $informacion->nombre_servicio_general ?></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><?php echo $informacion->calle_direccion; ?></td>
                        </tr>

                        <tr>
                            <th class="sorting_1">Idóneo</th>
                            <td><?php echo $informacion->idoneo_servicio_general; ?></td>
                        </tr>

                        <tr>
                            <th class="sorting_1">Descripción</th>
                            <td><?php echo $informacion->descripcion_servicio_general; ?></td>
                        </tr>
    ...
    <div class="card-footer mb-4 card">
        <div class="row no-print">
            <div class="col-12">
                <a href="?controlador=servigenerales&accion=imprimirInfo&id=<?= $id; ?>" rel="noopener" class="btn btn-default float-right">
