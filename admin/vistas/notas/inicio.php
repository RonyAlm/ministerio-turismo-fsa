    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a class="text-success" href="index2.php?controlador=notas&accion=inicio">Inicio</a></li>
              ...
              <tr>
                ...
                <td class="project-actions text-right">
                  <div class="btn-group" role="group" aria-label="">
                    ...
                    <a title="Más Infomación" id="btn1" href="?controlador=notas&accion=info&id=<?= $notas["id_notas"]; ?>" class="btn btn-primary btn-sm">
