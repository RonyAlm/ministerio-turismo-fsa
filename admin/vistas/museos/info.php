            ...
            <div class="card card-info">
                ...
                <div class="card-body">
                    <dl>
                        ...
                        <dd><?php echo $agenciasInfomacion->nombre_museo ?></dd>
                        <dt>Localidad:</dt>
                        <dd><?php echo $agenciasInfomacion->nombre_localidad; ?></dd>
                        <dt>Dirección:</dt>
                        <dd><?php echo $agenciasInfomacion->calle_direccion; ?></dd>
                        <dt>Idóneo:</dt>
                        <dd><?php echo $agenciasInfomacion->idoneo_museo; ?></dd>
                        <dt>Días y Horarios:</dt>
                        <dd><?php echo $agenciasInfomacion->horario_dia_museo; ?></dd>
                        <dt>Descripción:</dt>
                        <dd><?php echo $agenciasInfomacion->descripcion_museo; ?></dd>
                    </dl>
                </div>
                <!-- /.card-body -->
            </div>
