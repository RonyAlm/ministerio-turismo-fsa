          ...
          <div class="card card-success card-outline">
            ...
            <div class="card-body">
              ...
              <div class="form-group fg-description">
                ...
                <input type="hidden" id="museosID" name="museosID" value="<?php echo $editar->id_museo; ?>">
                <textarea value="<?php echo $editar->descripcion_museo; ?>" name="DescripcionMuseo" id="DescripcionMuseo" cols="65" class="form-control"><?php echo $editar->descripcion_museo; ?></textarea>
