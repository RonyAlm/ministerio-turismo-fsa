            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <div class="select2-success">
                  ...
                  ?>
                  <select class="select2" id="serviciosPrestador" name="serviciosPrestador[]" multiple="multiple" data-placeholder="Seleccionar Servicios" data-dropdown-css-class="select2-success" style="width: 100%;">
