...
include_once("conexion.php");
    ...
    class ControladorReferentes{
        ...
        public function inicio(){//aca se muestra las tablas
        ...
        public function crear(){
            ...
            if ($_POST) {
                ...
                $insertarReferente->crear($nombreReferente,$localidadReferente,
                                        $domicilioReferente,$telefonoReferente,
                                        $telefonoFijoReferente,$correoReferente,$facebookReferente,
                                        $instagramReferente,$twitterReferente,$webReferente,
                                        $otroReferente,$referenteEncargado);

                header("Location:./?controlador=referentes&accion=inicio");
        ...
        public function editar(){//aca se muestra las tablas
            ...
            if ($_POST) {
                ...
                $insertarReferente->editar($nombreReferente,$localidadReferente,
                                        $domicilioReferente,$telefonoReferente,
                                        $telefonoFijoReferente,$correoReferente,$facebookReferente,
                                        $instagramReferente,$twitterReferente,$webReferente,
                                        $otroReferente,$referenteID,
                                        ...
                                        $referenteTwitterID,
                                        $referenteWebID,
                                        $referenteOtroID,$referenteDomicilioID,$referenteEncargado);
        ...
        public function borrar(){//aca se muestra las tablas
        ...
        public function info(){//aca se muestra las tablas
