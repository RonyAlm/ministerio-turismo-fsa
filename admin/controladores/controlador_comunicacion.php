...
include_once("modelos/comunicacion.php");
...
class ControladorComunicacion
{
    ...
    { //aca se muestra las tablas
        ...
        if (isset($_POST['inputMotivo'])) {
            ...
            $agregarusuario = new ComunicacionModelo();
            print_r($_POST);
    ...
    public function crear()
    {
        ...
        $select_busquedas = new ComunicacionModelo();
        ...
        if ($_POST) {
            ...
            $insertarTransporte = new ComunicacionModelo();
    ...
    public function editar()
    {
        ...
        $buscarnotas = new ComunicacionModelo();
        ...
        if ($_POST) {
            $EditarAgencia = new ComunicacionModelo();
            // echo '<pre>';
            // print_r($_POST);
            // echo '</pre>';
        ...
        $buscarID = new ComunicacionModelo();
    ...
    public function borrar()
    {
        ...
        $borrarnotas = new ComunicacionModelo();
    ...
    public function info()
    {
        ...
        $agenciaInfo = new ComunicacionModelo();
    ...
    {
        $consultaAgencia = new ComunicacionModelo();
