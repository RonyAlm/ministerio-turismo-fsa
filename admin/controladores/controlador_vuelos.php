...
class ControladorVuelos
{
    ...
    { //aca se muestra las tablas
        ...
        include_once("vistas/vuelos/inicio.php");
    }
    public function select()
    {
        // $conexionBD = BD::crearInstancia();

        // $asdf = new VuelosModelo();
...

    {
        ...
        $select_tipo_servigeneral = new VuelosModelo();
        ...
        if ($_POST) {
            $EditarAgencia = new VuelosModelo();
    ...
    public function borrar()
    {
        ...
        $borrarAgencias = new VuelosModelo();
